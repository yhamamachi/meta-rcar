...
#                 <software_name>,<package_name>,<copy_file_name> \
#                 <software_name>,<package_name>,<copy_file_name>"
_video_dec_list="H264_decoder,EVARTM0AC0000XV264D30SL40C,RTM0AC0000XV264D30SL40C.tar.bz2 \
...
#                 <software_name>,<package_name>,<copy_file_name> \
#                 <software_name>,<package_name>,<copy_file_name>"
_video_enc_list="H264_encoder,EVARTM0AC0000XV264E30SL40C,RTM0AC0000XV264E30SL40C.tar.bz2"
...
#           <package_name(user)>,<copy_file_name(user)>,<package_name(kernel)>,<copy_file_name(kernel)>"
_gfx_list="EVARTM0RC7795GLTG0001SL40C,r8a7795_linux_gsx_binaries_gles3.tar.bz2,RCH3G001L4001ZDO,GSX_KM_H3.tar.bz2 \
    ...
    do
        ...
        if [ -z "${_find_filename}" ]; then
            ...
            if [ ${_audio_common_install} -eq 0 ]; then
                ...
                install -m 644 $1/EVARTM0AC0000XACMND30SL40C/Software/RTM0AC0000XACMND30SL40C.tar.gz ${_OMX_UM_INST_DIR}
...
func_audio()
{
    ...
    func_search_and_md5check "EVARTM0AC0000XACMND30SL40C" \
...
func_search_omx_common()
{
    ...
    func_search_and_md5check "EVARTM0AC0000XCMCTL30SL40C" \
...
func_install_omx_common()
{
    if [ ${_omx_common_install} -eq 0 ]; then
        ...
        install -d ${_OMX_UM_INST_DIR}
        install -m 644 ${_omx_common_top_dir}/EVARTM0AC0000XCMCTL30SL40C/Software/RTM0AC0000XCMCTL30SL40C.tar.bz2 ${_OMX_UM_INST_DIR}
...
func_video_decoder_lib()
{
    ...
    func_search_and_md5check "EVARTM0AC0000XVCMND30SL40C" \
    ...
    do
        ...
        if [ -z "${_find_filename}" ]; then
            ...
            if [ ${_video_decoder_common_install} -eq 0 ]; then
                ...
                install -m 644 ${video_decoder_common_top_dir}/EVARTM0AC0000XVCMND30SL40C/Software/RTM0AC0000XVCMND30SL40C.tar.bz2 ${_OMX_UM_INST_DIR}
...
func_video_encoder_lib()
{
    ...
    func_search_and_md5check "EVARTM0AC0000XVCMNE30SL40C" \
    ...
    do
        ...
        if [ -z "${_find_filename}" ]; then
            ...
            if [ ${_video_encoder_common_install} -eq 0 ]; then
                ...
                install -m 644 ${video_encoder_common_top_dir}/EVARTM0AC0000XVCMNE30SL40C/Software/RTM0AC0000XVCMNE30SL40C.tar.bz2 ${_OMX_UM_INST_DIR}
