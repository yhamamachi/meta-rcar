...
SRC_URI_append = \
    " file://0001-Add-RCAR_BKUP_ENABLE-flag.patch \
      ...
      file://0002-plat-renesas-rcar-Make-RPC-secure-settings-optional.patch \
"
...
ATFW_OPT_append = " \
    ...
    ${@base_conditional("DISABLE_NONSECURE_RPC_ACCESS", "1", " RCAR_DISABLE_NONSECURE_RPC_ACCESS=1", "", d)} \
"
